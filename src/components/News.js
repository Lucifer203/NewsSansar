...
export default class News extends Component {
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5dfeff9303ba42459344afbe6c65ed73&page=1&pageSize=${this.props.pageSize}`;
  ...
  handlePreviousClick = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5dfeff9303ba42459344afbe6c65ed73&page=${
      this.state.page - 1
  ...
  render() {
    return (
      <div className="container my-3">
        <h1 className="text-center">NewsSansar Top Headlines</h1>
